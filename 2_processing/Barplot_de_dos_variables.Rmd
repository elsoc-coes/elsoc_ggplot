...
## Gráficos de barra que relacionan dos variables

En este instructivo aprenderá a realizar gráficos de barra simples para datos longitudinales. Esta sección elabora análisis para una sola variable categórica, la cual se puede agrupar bajo una variable categoría.
...
### 2.3 Dos categorías de agrupación: Edad y Ola
```{r}
