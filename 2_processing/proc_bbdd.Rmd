...
- `tipo_atricion`: indica cuáles son los entrevistados en cada ola incluidas en la versión de la base de datos combinada.
...
elsoc_long$ola <- factor(elsoc_long$ola,levels=c("1","2","3","4"), labels = c('2016', '2017', '2018', '2019'))
